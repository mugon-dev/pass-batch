...
public class SendNotificationBeforeClassJobConfig {
    ...
    // thread-safe한 cursor 방식을 사용하기 위해
    @Bean
    ...
    /**
     * <p>JpaPagingItemReader: JPA에서 사용하는 페이징 기법</p>
     * <p>쿼리 당 pageSize 만큼 가져오며 다른 PagingItemReader와 마찬가지로 Thread-safe함</p>
     * <p>update가 필요없기에 cursor 대신 사용</p>
     */
    @Bean
